...
if (isset($_POST['search-term'])) {
    ...
    $sql = "SELECT * FROM `disciplinary` WHERE `title` LIKE  '$search_term' OR `id_number` LIKE  '$search_term' OR `note` LIKE  '$search_term' LIMIT $start, $rows_per_page";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
    ...
    $start = 0;
    $rows_per_page = 5;
    $sql_row = "SELECT * FROM disciplinary";
...
$sql = "SELECT * FROM disciplinary LIMIT $start, $rows_per_page";
...
<div class="container">
    ...
    <section id="menu">
        ...
        <div class="items">
            ...
            <a href="./disciplinary-action.php" class="active">
    ...
    <section id="interface" class="interface">
        ...
        <div class="search_and_i-name">
            <div class="search2">
                ...
                <form action="disciplinary-action.php" method="post">
        ...
        <div class="board">
            ...
            <div class="add_faculty-btn">
                <a href="add-disciplinary.php" class="btn">Add Data</a>
            </div>
            <table width="100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach ($records as $key => $row) : ?>
                        <tr>
                            ...
                            if (!empty($row['filename'])) { ?>
                                <td>
                                    <a class="edit" href="<?php
                                                            ...
                                                            } elseif (file_exists('../student/uploads/' . $row['filename'])) {
                                                                echo '../student/uploads/' . $row['filename'];
                                                            }
                            ...
                            <td><a href="edit-disciplinary.php?id=<?= $row['id']; ?>" class="edit">Edit</a></td>
                            <td><a href="disciplinary-action.php?del_id=<?= $row['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this?')">Delete</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
