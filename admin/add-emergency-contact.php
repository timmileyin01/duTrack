...
<div class="container form-pages">
    <div class="form">
        <h2>Add Emergency Data</h2>
        <div class="question" style="display: flex; flex-direction: row; gap: 1rem; align-items: center; justify-content: center;">
            <span class="text-muted">Click to add Bulk Data</span><a href="add-bulk-emergency.php" class="btn" style="background: blue;">Add Bulk Data</a>
        </div>

        <?php include(base_app . "adminHelpers/formErrors.php"); ?>

        <form action="add-emergency-contact.php" method="post">
            ...
            <div>
                <button type="submit" name="add-emergency" class="btn">Submit Data</button>
            </div>
        </form>
    </div>
</div>
