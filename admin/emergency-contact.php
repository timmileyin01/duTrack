...
if (isset($_POST['search-term'])) {
    ...
    $sql = "SELECT * FROM `emergency_contacts` WHERE `surname` LIKE  '$search_term' OR `firstname` LIKE  '$search_term' OR `middlename` LIKE  '$search_term' OR `id_number` LIKE  '$search_term' LIMIT $start, $rows_per_page";
    $stmt = $conn->prepare($sql);
    $stmt->execute();
    ...
    $start = 0;
    $rows_per_page = 5;
    $sql_row = "SELECT * FROM emergency_contacts";
...
$sql = "SELECT * FROM emergency_contacts LIMIT $start, $rows_per_page";
    ...
    <section id="interface" class="interface">
        ...
        <div class="search_and_i-name">
            <div class="search2">
                ...
                <form action="emergency-contact.php" method="post">
        ...
        <div class="board">
            ...
            <div class="add_faculty-btn">
                <a href="add-emergency-contact.php" class="btn">Add Data</a>
            </div>
            <table width="100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach ($records as $key => $row) : ?>
                        <tr>
                            ...
                            <td><a href="edit-emergency-contact.php?id=<?= $row['id']; ?>" class="edit">Edit</a></td>
                            <td><a href="emergency-contact.php?del_id=<?= $row['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this?')">Delete</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
