...
<div class="container form-pages">
    <div class="form">
        <h2>Add Document Data</h2>
        <?php include(base_app . "adminHelpers/formErrors.php"); ?>

        <form action="add-document.php" enctype="multipart/form-data" method="post">
            ...
            <div>
                <button type="submit" name="add-document" class="btn">Submit Data</button>
            </div>
        </form>
    </div>
</div>
